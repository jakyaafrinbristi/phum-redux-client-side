...
export const {useGetAllSemestersQuery,useCreateAcademicSemestersMutation,
  useCreateAcademicFacultyMutation,useGetAcademicFacultiesQuery,useCreateAcademicDepartmentMutation,useGetAcademicDepartmentsQuery }=academicManagementApi;